...
class Background(GameSprite):
    def __init__(self,is_alt = False):
        ...
        #两张图像交替循环
        #传图片
        super().__init__("/home/zh/Pictures/bg_01.png")
        if is_alt:
...
class Enemy(GameSprite):
    ...
    def __init__(self):
        ...
        super().__init__("/home/zh/Pictures/hero.png")
...
class Hero(GameSprite):
    def __init__(self):
        super().__init__("/home/zh/Pictures/hero.png",0)
...
class Bullet(GameSprite):
    ...
    def __init__(self):
        super().__init__("/home/zh/Pictures/bullet_1.png",-5)
    def update(self):
        super().update()
